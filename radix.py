...
def hex2bin(hstr):
    ...
    if remainder == 0:                                                              #check if remainder is zero and set length to length of
        length = len(bin_form)                                                      #binary f string if divisible by 4, else set var length
    else:                                                                           #to length of binary f string plus 4 minus remainder to
